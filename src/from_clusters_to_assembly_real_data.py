...
def get_final_assembly_without_paths(contig_map, path_to_output):
    ...
    seqs.append(record)
    SeqIO.write(seqs, path_to_output + max_output_file + "rambler.final", "fasta")
...
paf_file = "../arabidopsis/output/"+input_filename+"/"+methods[0]+"/overlaps.paf"
path_to_output = "../arabidopsis/output/"+input_filename+"/"+methods[0]+"/final_assembly/"
contigs_file = SeqIO.parse("../arabidopsis/output/"+methods[0]+"/asm.fasta", 'fasta')
